            ...
            <tbody>
                <?php foreach ($result as $row): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit-admin.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn edit">Editar</a>
                            <a href="delete-admin.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn delete" onclick="return confirm('Tem certeza que deseja excluir?')">Excluir</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
